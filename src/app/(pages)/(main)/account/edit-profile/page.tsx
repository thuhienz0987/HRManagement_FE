...
const EditUserProfile = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async ({
      ...
      try {
        const response = await axiosPrivate.put(`/user/${_id}`, formData, {
          headers: {
          ...
          <div className="md:grid flex flex-col grid-cols-1 md:grid-cols-2 md:grid-flow-row w-full pt-16 pb-3 px-5 gap-y-2 gap-x-7">
            ...
            <div>
              <Input
                ...
                key={"ethnic"}
                type="text"
                label={<p className="text-[#5B5F7B] font-medium">Ethnic</p>}
            ...
            <Input
              ...
              key={"basicSalary"}
              type="number"
              label={<p className="text-[#5B5F7B] font-medium">Basic salary</p>}
              labelPlacement={"outside"}
            ...
            <div>
              ...
              <Input
                ...
                type="text"
                label={
                  <p className="text-[#5B5F7B] font-medium">Salary grade</p>
                }
                labelPlacement={"outside"}
              ...
              {errors.salaryGrade && touched.salaryGrade && (
                <span className={errorClassName}>{errors.salaryGrade}</span>
              )}
            </div>
            <Input
              isDisabled
