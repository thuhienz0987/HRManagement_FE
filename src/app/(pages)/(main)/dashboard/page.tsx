      ...
      <div className="flex flex-1   lg:flex-row flex-col max-sm:gap-y-4">
        <div className="flex flex-col gap-y-8 lg:w-4/6 w-full max-sm:gap-y-4">
          <User
            ...
            name={
              <p className=" text-2xl font-medium">Hi, {session?.user.name}</p>
            }
            description={
              <p className="text-[#C89E31]">{session?.user.positionId.name}</p>
            }
            avatarProps={{
          ...
          {status ? (
            <div className="flex gap-5 flex-col flex-wrap md:flex-row xl:flex-nowrap max-sm:gap-y-4">
              <CircleProgress
                ...
                percentage={
                  ((status.onTimeEmployeesToday + status.lateEmployeesToday) /
              ...
              <CircleProgress
                ...
                percentage={
                  (status.onTimeEmployeesToday / status.totalEmployees) * 100
                }
              ...
              <CircleProgress
                ...
                percentage={
                  (status.lateEmployeesToday / status.totalEmployees) * 100
                }
          ...
          {session && !session.user.roles.includes(process.env.HRManager) && (
