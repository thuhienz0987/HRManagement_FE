...
const eventSchema = yup.object({
  ...
  users: yup.array().of(yup.string()).min(1, "Event must have at least 1 user"),
    ...
    return (
      ...
      >
        {employees &&
          selected.map((value) => (
            <Chip key={value}>
              {employees.find((emp) => `${emp._id}` === `${value}`)?.name}
            </Chip>
          ))}
      </ScrollShadow>
    );
          ...
          <div className="flex flex-row min-h-[300px] gap-3">
            <div className="flex flex-1 flex-col">
              <InputText
                ...
                label={
                  selectedOption == "meeting" ? "Event Name" : "Holiday name"
                }
                placeHolder={
                  selectedOption == "meeting"
                    ? "Eg. Annual meeting"
                ...
                onChange={(e) => {
                  selectedOption == "meeting"
                    ...
                    : holidayForm.setFieldValue("name", e.target.value);
                }}
              />
              {selectedOption == "meeting" &&
              ...
              <div className=" w-80 h-10 p-0 mt-2 gap-2 flex flex-col">
                ...
                {selectedOption == "meeting" && (
                  <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <div className="flex flex-col">
                      <TimeField
                        defaultValue={eventForm.values.time}
                        label={"Start"}
                        onChange={(val) => eventForm.setFieldValue("time", val)}
                        sx={{
                          width: "100%",
                          borderWidth: "0px",
                ...
                <SingleDatePicker
                  ...
                  setDate={(date) => {
                    selectedOption == "meeting"
                      ? eventForm.setFieldValue("dateTime", date)
                      : holidayForm.setFieldValue("day", date);
                  }}
                />
                {selectedOption == "meeting" &&
                  eventForm.errors.dateTime &&
            ...
            <div className="flex flex-1 flex-col">
              ...
              {selectedOption == "meeting" &&
                eventForm.errors.name &&
                eventForm.touched.name && (
                  <span className={"text-white " + errorClassName}>
                    {eventForm.errors.name}
                  </span>
                )}
              {selectedOption == "holiday" &&
                ...
                <>
                  ...
                  >
                    ...
                    <PopoverContent className=" w-80">
                      {employees ? (
                        <Listbox
                          disabledKeys={eventForm.values.optionalUsers}
                          classNames={{
                            base: "max-w-xs",
                          ...
                          onSelectionChange={(key) => {
                            ...
                            setSelectedEmpId(
                              selectedArray.map((key) => key.toString())
                            );
                ...
                <>
                  ...
                  >
                    ...
                    <PopoverContent className=" w-80">
                      {employees ? (
                        <Listbox
                          disabledKeys={eventForm.values.users}
                          classNames={{
                            base: "max-w-xs",
                            list: "max-h-[200px] overflow-y-scroll",
                          }}
                  ...
                  {selectedOption == "meeting" && (
                    <>
                      <InputText
                        ...
                        onChange={(e) => {
                          eventForm.setFieldValue("room", e.target.value);
                        }}
                        value={eventForm.values.room}
                      />
                      {eventForm.errors.room && eventForm.touched.room && (
                        <span className={errorClassName}>
        ...
        <div className="flex flex-1 flex-col px-2 lg:px-9 bg-gray-50 dark:bg-bar_dark rounded-l items-center border justify-center relative">
          ...
          <div className=" px-0 lg:px-4 justify-self-center self-center w-full">
            <ScrollShadow
              ...
              hideScrollBar
            >
              {hasEventDate(selectedDay) || hasHolidayDate(selectedDay) ? (
                <>
                  <>
                        ...
                        <div className="border p-4 border-gray-400 border-solid rounded-xl mb-4 w-full">
                          <div className="flex justify-between">
                            ...
                            <p className="text-right text-xs font-light leading-3 text-gray-500 dark:text-white">
                              {format(parseISO(event.dateTime), "h:mm aa")}
                            </p>
                          </div>
                  ...
                  <>
                    {selectedDayHoliday?.map((holiday) => (
                      <div className="w-full " key={holiday._id}>
                        <div className="border p-4 border-gray-400 border-solid rounded-xl mb-4 w-full">
                          <div className="flex justify-between">
                            <a
                              // tabindex="0"
